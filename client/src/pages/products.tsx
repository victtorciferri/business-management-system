...
import { Loader2, PlusCircle, Search, Tag, DollarSign, ShoppingBag, Pencil, Trash2 } from "lucide-react";
...
export default function ProductsPage() {
  ...
  const categories = [
    "all", 
    ...Array.from(new Set(products.map((product: Product) => product.category))).sort()
  ];
