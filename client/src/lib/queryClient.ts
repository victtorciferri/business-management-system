 ...
 * Build API URL
 * 
 * Note: Business slug transformation is intentionally disabled for simplicity.
 * Staff, appointments, customers, and other core endpoints are global and 
 * don't require business-specific URL prefixes. The backend businessExtractor
 * middleware handles business context via reserved paths.
 */
