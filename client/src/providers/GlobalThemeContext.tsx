 ...
 * 
 * This context provides global theme settings and preferences
 * that apply application-wide, regardless of the current business.
 */

import { createContext } from 'react';

// Define the shape of the global theme tokens
